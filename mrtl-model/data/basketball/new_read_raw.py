...
if __name__ == '__main__':
    ...
    game_logs_headers = ['team_no', 'possession_no', 'teamID_A', 'teamID_B', 'timestamps', 'shot_clock', 'quarter', 'bh_ID', 'bh_x', 'bh_y',
                         ...
                         'def5_dist_from_bh', 'def1_rel_angle_from_bh', 'def2_rel_angle_from_bh', 'def3_rel_angle_from_bh', 
                         'def4_rel_angle_from_bh', 'def5_rel_angle_from_bh', 'def1_trunc_x', 'def1_trunc_y', 'def2_trunc_x', 
...
#     shot_logs_csv_file.close()
    ...
    df.to_pickle(os.path.join('/datasets/home/81/481/mzkhan/SpatiotemporalBasketball/mrtl-model/output/', 'full_data_intr.pkl'))
    ...
    df.to_pickle(os.path.join('/datasets/home/81/481/mzkhan/SpatiotemporalBasketball/mrtl-model/output/', 'full_data_9.pkl'))
